...
if __name__ == '__main__':
   ...
   learners = [
      ...
      EpisodicLearner(epsilon, EMT(6000, ProjRouter(proj="RNG"), RankScorer ("exp",['x','a','xa']), c=ConstSplitter(100), d=0.00, alpha=0)),
   ...
   #environments = Environments.from_openml(task_id=167121, cat_as_str=True, take=200).scale().sparse()
