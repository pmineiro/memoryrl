...
config     = {"processes": 192, "chunk_by":'task' }
...
if __name__ == '__main__':
   ...
   environments = Environments.from_openml(task_id=benchmark_tasks, cat_as_str=True, take=4000).scale().shuffle(list(range(100)))
   ...
   result = Experiment(environments, learners, environment_task=ClassEnvironmentTask(), evaluation_task=SlimOnlineOnPolicyEvalTask()).config(**config).evaluate(log)
   result.plot_learners(y='reward')
