...
log        = "./study1/outcomes/full-openml-class-3.log.gz"
...
if __name__ == '__main__':
   ...
   learners = [
      ...
      MemorizedLearner2(epsilon, CMT(6000, PCARouter(['x']), RankScorer("exp",['x','a','xa'],True ), c=ConstSplitter(100), v=(2,), d=0, alpha=0), "xxa", False, True),
   ...
   Experiment(environments, learners, environment_task=ClassEnvironmentTask(), evaluation_task=OnlineOnPolicyEvalTask()).config(**config).evaluate(log).filter_fin().plot_learners(sort="y")
