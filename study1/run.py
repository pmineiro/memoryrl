...
from scorers import RandomScorer, DistScorer, RankScorer, RankScorer2, RankScorer3, RankScorer4
...
log        = "./study1/outcomes/full-openml-class-4.log.gz"
...
if __name__ == '__main__':
   ...
   #seed = list(range(4))
   #seed = 1
   #environments = Environments.from_kernel_synthetic(500, n_context_features=20, n_action_features=0 ,seed=seed).scale(shift='min',scale='minmax',target='rewards').binary()
